...
public class DateUtil {
     ...
     * @return
     */
    public static String longTimeToDate(Long millSec, String pattern) {
        if (millSec == null) {
            return null;
        }
	...
	public static String getTime(long time) {
		...
		str = unitFormat(h) + ":" + unitFormat(m) + ":" + unitFormat(s) ;  
		return str ;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(longTimeToDate((long)as,"HH:mm:ss"));
		System.out.println(longTimeToDate((long)ae,"HH:mm:ss"));
		System.out.println(longTimeToDate((long)bs,"HH:mm:ss"));
		System.out.println(longTimeToDate((long)be,"HH:mm:ss"));
		System.out.println(longTimeToDate((long)cs,"HH:mm:ss"));
		System.out.println(longTimeToDate((long)ce,"HH:mm:ss"));
		System.out.println(longTimeToDate((long)ds,"HH:mm:ss"));
		System.out.println(longTimeToDate((long)fe,"HH:mm:ss"));
		
		
//		Date date = new Date();
//		System.out.println(date);
//		String time = longToDate(date.getTime(),"HH-mm-ss");

...
public class ReviewVideoManagerSegments {
	//开始时间
	private String offsetBeginStr;
	
	//结束时间
	private String offsetEndStr;
	
    public String getOffsetBeginStr() {
		return offsetBeginStr;
	}

	public void setOffsetBeginStr(String offsetBeginStr) {
		this.offsetBeginStr = offsetBeginStr;
	}

	public String getOffsetEndStr() {
		return offsetEndStr;
	}

	public void setOffsetEndStr(String offsetEndStr) {
		this.offsetEndStr = offsetEndStr;
	}

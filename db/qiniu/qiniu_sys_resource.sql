...
CREATE TABLE `sys_resource` (
  ...
  `resource_nm` varchar(50) DEFAULT NULL,
  `resource_type` varchar(1) DEFAULT NULL,
  `resource_ident` varchar(100) DEFAULT NULL,
  `resource_url` varchar(100) DEFAULT NULL,
  `is_show` varchar(1) DEFAULT NULL,
  `resource_pic` varchar(100) DEFAULT NULL,
  `sort_no` int(11) DEFAULT NULL,
  `parent_resource_id` varchar(36) DEFAULT NULL,
...
-- Dump completed on 2018-07-11 15:35:28

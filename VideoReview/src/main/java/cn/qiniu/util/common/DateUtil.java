...
//		String url = "http://ow8zztdmn.bkt.clouddn.com/o_1bt6ol63717p5a6fnvdf61p011c.mp4";
//		//截取归档地址获取文件名
//		String fileName = url.substring(url.lastIndexOf("/")+1);
//		System.out.println(fileName);
//		
//		int jpgName = fileName.indexOf(".");
//		System.out.println(jpgName);
//		
//		int bucketSize = url.lastIndexOf("/")+1;
//
//		
//		String newName = fileName.substring(0,jpgName);
//		System.out.println(newName);
//		
//		String bucketUrl = url.substring(0, bucketSize);
